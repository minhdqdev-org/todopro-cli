...
class TestE2EESyncIntegration:
    ...
    def mock_e2ee_handler(self, mock_encryption_service):
        ...
        def prepare_task(content, description=None):
            ...
            enc_desc = json.dumps(mock_encryption_service.encrypt(description)) if description else None
    ...
    async def test_rest_api_repository_encrypts_on_create(self, mock_e2ee_handler):
        ...
        # Mock the tasks API
        mock_tasks_api = Mock()
        mock_tasks_api.create_task = AsyncMock(return_value={
            "id": "task-123",
            "content": "",
    ...
    def test_get_e2ee_handler_respects_config(self, mock_get_config):
        ...
        with patch("todopro_cli.adapters.sqlite.e2ee.EncryptionService") as mock_enc_cls:
            mock_enc = Mock()
