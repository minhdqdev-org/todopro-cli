...
# from .commands.reset_command import app as reset_app  # DISABLED: Focus mode goals - deferred
# from .commands.resume_command import app as resume_app  # DISABLED: Focus mode - deferred
# from .commands.rotate_command import app as rotate_app  # DISABLED: Replaced by encryption.py
# from .commands.set_command import app as set_app  # DISABLED: Focus mode goals - deferred
# from .commands.setup_command import app as setup_app  # DISABLED: Replaced by encryption.py
# from .commands.show_command import app as show_app  # DISABLED: Focus/timer/analytics - deferred
from .commands.signup_command import app as signup_app
# from .commands.start_command import app as start_app  # DISABLED: Focus/timer - deferred
# from .commands.status_command import app as status_app  # DISABLED: Focus mode - deferred
# from .commands.stop_command import app as stop_app  # DISABLED: Focus mode - deferred
...
# app.add_typer(show_app, name="show", help="Show information (stats, analytics, etc.)")  # DISABLED: Focus/timer/analytics - deferred
app.add_typer(use_app, name="use", help="Switch/use contexts")
# app.add_typer(set_app, name="set", help="Set configuration and goals")  # DISABLED: Focus mode goals - deferred
# app.add_typer(start_app, name="start", help="Start focus sessions and timers")  # DISABLED: Focus/timer - deferred
# app.add_typer(stop_app, name="stop", help="Stop focus sessions")  # DISABLED: Focus mode - deferred
# app.add_typer(resume_app, name="resume", help="Resume paused focus sessions")  # DISABLED: Focus mode - deferred
...
app.add_typer(sync_app, name="sync", help="Sync data between local and remote")  # Working sync commands
app.add_typer(data_app, name="data", help="Export/import data")  # Working export/import commands
app.add_typer(encryption_app, name="encryption", help="Manage end-to-end encryption")  # E2EE commands
# app.add_typer(setup_app, name="setup", help="Setup encryption")  # DISABLED: Replaced by encryption.py
# app.add_typer(status_app, name="status", help="Show status (focus, encryption)")  # DISABLED: Focus mode - deferred
